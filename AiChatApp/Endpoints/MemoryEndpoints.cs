            ...
            <div class='card-body p-4'>
                <div class='flex justify-between items-start mb-2'>
                    ...
                    <div class='flex items-center gap-3'>
                        ...
                        <button hx-delete='/api/memories/{fileName}' hx-target='closest .card' hx-swap='outerHTML swap:0.3s'
                ...
                <div class='flex items-center justify-between mt-2 pt-2 border-t border-base-300/50'>
                    <span class='text-[10px] uppercase tracking-wider opacity-40 font-bold'>
                        {(isShared ? "<i>Claude Code</i>" : $"<i>Ref:</i> {m.AccessCount}")} &nbsp;|&nbsp; {m.CreatedAt:yyyy-MM-dd HH:mm}
                    </span>
                </div>
            </div>
        </div>";
